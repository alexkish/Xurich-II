	...
	// run_06
	const char *DataFolder = "/Users/alexkish/data/xurich/xurich2/run_06/S1_chi2"; // idark05
...
*/
	...
	sprintf(DataFile1, "%s/%s/%s.root", DataFolder, DataSet1, DataSet1);			
	Char_t  DataFile2[500];
	sprintf(DataFile2, "%s/%s/%s.root", DataFolder, DataSet2, DataSet2);			
	Char_t  DataFile3[500];
	sprintf(DataFile3, "%s/%s/%s.root", DataFolder, DataSet3, DataSet3);			
	Char_t  DataFile4[500];
	sprintf(DataFile4, "%s/%s/%s.root", DataFolder, DataSet4, DataSet4);			
	Char_t  DataFile5[500];
	sprintf(DataFile5, "%s/%s/%s.root", DataFolder, DataSet5, DataSet5);			
	Char_t  DataFile6[500];
	sprintf(DataFile6, "%s/%s/%s.root", DataFolder, DataSet6, DataSet6);			
	Char_t  DataFile7[500];
	sprintf(DataFile7, "%s/%s/%s.root", DataFolder, DataSet7, DataSet7);			
	Char_t  DataFile8[500];
	sprintf(DataFile8, "%s/%s/%s.root", DataFolder, DataSet8, DataSet8);			
	Char_t  DataFile9[500];
	sprintf(DataFile9, "%s/%s/%s.root", DataFolder, DataSet9, DataSet9);			
	Char_t  DataFile10[500];
	sprintf(DataFile10, "%s/%s/%s.root", DataFolder, DataSet10, DataSet10);			
	Char_t  DataFile11[500];
	sprintf(DataFile11, "%s/%s/%s.root", DataFolder, DataSet11, DataSet11);			
	Char_t  DataFile12[500];
	sprintf(DataFile12, "%s/%s/%s.root", DataFolder, DataSet12, DataSet12);			
	Char_t  DataFile13[500];
	sprintf(DataFile13, "%s/%s/%s.root", DataFolder, DataSet13, DataSet13);			
	Char_t  DataFile14[500];
	sprintf(DataFile14, "%s/%s/%s.root", DataFolder, DataSet14, DataSet14);			
	Char_t  DataFile15[500];
	sprintf(DataFile15, "%s/%s/%s.root", DataFolder, DataSet15, DataSet15);			
	Char_t  DataFile16[500];
	sprintf(DataFile16, "%s/%s/%s.root", DataFolder, DataSet16, DataSet16);			
/*	Char_t  DataFile17[500];
	sprintf(DataFile17, "%s/%s/%s.root", DataFolder, DataSet17, DataSet17);			
	Char_t  DataFile18[500];
	sprintf(DataFile18, "%s/%s/%s.root", DataFolder, DataSet18, DataSet18);			
	Char_t  DataFile19[500];
	sprintf(DataFile19, "%s/%s/%s.root", DataFolder, DataSet19, DataSet19);			
	Char_t  DataFile20[500];
	sprintf(DataFile20, "%s/%s/%s.root", DataFolder, DataSet20, DataSet20);			
	Char_t  DataFile21[500];
	sprintf(DataFile21, "%s/%s/%s.root", DataFolder, DataSet21, DataSet21);			
	Char_t  DataFile22[500];
	sprintf(DataFile22, "%s/%s/%s.root", DataFolder, DataSet22, DataSet22);			
	Char_t  DataFile23[500];
	sprintf(DataFile23, "%s/%s/%s.root", DataFolder, DataSet23, DataSet23);			
	Char_t  DataFile24[500];
	sprintf(DataFile24, "%s/%s/%s.root", DataFolder, DataSet24, DataSet24);			
	Char_t  DataFile25[500];
	sprintf(DataFile25, "%s/%s/%s.root", DataFolder, DataSet25, DataSet25);			
	Char_t  DataFile26[500];
	sprintf(DataFile26, "%s/%s/%s.root", DataFolder, DataSet26, DataSet26);			
	Char_t  DataFile27[500];
	sprintf(DataFile27, "%s/%s/%s.root", DataFolder, DataSet27, DataSet27);			
*/
