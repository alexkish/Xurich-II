	...
	TH1F *h1_nS1 							= new TH1F("h1_nS1",							DataSetName1, 	25, 				25, 			25);
	TH1F *h1_S1 							= new TH1F("h1_S1",								DataSetName1, 	nbins_S1, 			min_S1, 		max_S1);
	TH1F *h1_S1a 							= new TH1F("h1_S1a",							DataSetName1, 	nbins_S1, 			min_S1, 		max_S1);
	TH1F *h1_S1b 							= new TH1F("h1_S1b",							DataSetName1, 	nbins_S1, 			min_S1, 		max_S1);
	...
	TH1F *h1_S1delay 						= new TH1F("h1_S1delay",						DataSetName1, 	nbins_S1delay, 		min_S1delay, 	max_S1delay);
	...
	TH2F *h2_S2BOTvsS1 						= new TH2F("h2_S2BOTvsS1",						DataSetName1, 	nbins_S1, 			min_S1, 		max_S1, 		nbins_S2bot, 		min_S2bot, 		max_S2bot);
	TH2F *h2_LOGS2S1vsS1 					= new TH2F("h2_LOGS2S1vsS1",					DataSetName1, 	nbins_S1, 			min_S1, 		max_S1, 		nbins_S2, 			0.0, 			5.0);
	TH2F *h2_LOGS2TOPS1vsS1 				= new TH2F("h2_LOGS2TOPS1vsS1",					DataSetName1, 	nbins_S1, 			min_S1, 		max_S1, 		nbins_S2, 			0.0, 			5.0);
	TH2F *h2_LOGS2BOTS1vsS1 				= new TH2F("h2_LOGS2BOTS1vsS1",					DataSetName1, 	nbins_S1, 			min_S1, 		max_S1, 		nbins_S2, 			0.0, 			5.0);
	TH2F *h2_LOGS2S1vsS1SUM 				= new TH2F("h2_LOGS2S1vsS1SUM",					DataSetName1, 	nbins_S1, 			min_S1, 		max_S1, 		nbins_S2, 			0.0, 			5.0);
	TH2F *h2_S1vsS1 						= new TH2F("h2_S1vsS1",							DataSetName1, 	nbins_S1/2, 		min_S1, 		max_S1, 		nbins_S1/2, 		min_S1, 		max_S1/8);
	TH2F *h2_S1vsS1_scat 					= new TH2F("h2_S1vsS1_scat",					DataSetName1, 	nbins_S1*10, 		min_S1, 		max_S1, 		nbins_S1*10, 		min_S1, 		max_S1/8);
	TH2F *h2_S1BOTvsS1BOT 					= new TH2F("h2_S1BOTvsS1BOT",					DataSetName1, 	nbins_S1/2, 		min_S1, 		max_S1, 		nbins_S1, 			min_S1, 		max_S1/64);
	TH2F *h2_S1BOTvsS1BOT_scat 				= new TH2F("h2_S1BOTvsS1BOT_scat",				DataSetName1, 	nbins_S1*10, 		min_S1, 		max_S1, 		nbins_S1*10, 		min_S1, 		max_S1/64);
	TH2F *h2_S2vsS2 						= new TH2F("h2_S2vsS2",							DataSetName1, 	nbins_S2/2, 		min_S2, 		max_S2, 		nbins_S2/2, 		min_S2, 		max_S2/50);
	TH2F *h2_S2TOPvsS2TOP 					= new TH2F("h2_S2TOPvsS2TOP",					DataSetName1, 	nbins_S2/2, 		min_S2, 		max_S2, 		nbins_S2/2, 		min_S2, 		max_S2/10);
	...
	TH2F *h2_S1ASYM1vsS1 					= new TH2F("h2_S1ASYM1vsS1",					DataSetName1, 	nbins_S1/2, 		min_S1, 		max_S1, 		nbins_S1/2, 		-1.0, 			+1.0);
	TH2F *h2_S1ASYMvsDT 					= new TH2F("h2_S1ASYMvsDT",						DataSetName1, 	nbins_dt/2, 		min_dt, 		max_dt, 		nbins_S1/2, 		-1.0, 			+1.0);
	TH2F *h2_S2ASYMvsS2 					= new TH2F("h2_S2ASYMvsS2",						DataSetName1, 	nbins_S2, 			min_S2, 		max_S2, 		nbins_S2/2, 		-1.0, 			+1.0);
	TH2F *h2_S2ASYMvsS2TOP 					= new TH2F("h2_S2ASYMvsS2TOP",					DataSetName1, 	nbins_S2, 			min_S2, 		max_S2, 		nbins_S2/2, 		-1.0, 			+1.0);
	...
	TH2F *h2_S2vsDT 						= new TH2F("h2_S2vsDT",							DataSetName1, 	nbins_dt, 			min_dt, 		max_dt, 		nbins_S2, 			min_S2, 		max_S2);
	TH2F *h2_S2TOPvsDT 						= new TH2F("h2_S2TOPvsDT",						DataSetName1, 	nbins_dt, 			min_dt, 		max_dt, 		nbins_S2, 			min_S2, 		max_S2);
	TH2F *h2_S2BOTvsDT 						= new TH2F("h2_S2BOTvsDT",						DataSetName1, 	nbins_dt, 			min_dt, 		max_dt, 		nbins_S2bot, 		min_S2bot, 		max_S2bot);
	...
	TH2F *h2_S2WIDTHTOPvsS2TOP 				= new TH2F("h2_S2WIDTHTOPvsS2TOP",				DataSetName1, 	nbins_S2, 			min_S2, 		max_S2, 		nbins_S2width/2, 	min_S2width, 	max_S2width);
	...
	TH2F *h2_S2WIDTHoverHEIGHTTOPvsS2TOP 	= new TH2F("h2_S2WIDTHoverHEIGHTTOPvsS2TOP",	DataSetName1, 	nbins_S2*10, 		min_S2, 		max_S2, 		nbins_S2*10, 		1e-5, 			1e-1);
	TH2F *h2_S2WIDTHoverHEIGHTBOTvsS2BOT 	= new TH2F("h2_S2WIDTHoverHEIGHTBOTvsS2BOT",	DataSetName1, 	nbins_S2*10, 		min_S2, 		max_S2, 		nbins_S2*10, 		1e-5, 			1e-1);
	TH2F *h2_S2WIDTHLOWoverHEIGHTTOPvsS2TOP = new TH2F("h2_S2WIDTHLOWoverHEIGHTTOPvsS2TOP",	DataSetName1, 	nbins_S2*10, 		min_S2,	 		max_S2, 		nbins_S2*10, 		1e-5, 			1e-1);
	TH2F *h2_S2WIDTHLOWoverHEIGHTBOTvsS2BOT = new TH2F("h2_S2WIDTHLOWoverHEIGHTBOTvsS2BOT",	DataSetName1, 	nbins_S2*10, 		min_S2,	 		max_S2, 		nbins_S2*10, 		1e-5, 			1e-1);
	...
	TH2F *h2_S2HEIGHTTOPvsS2TOP 			= new TH2F("h2_S2HEIGHTTOPvsS2TOP",				DataSetName1, 	nbins_S2, 			min_S2, 		max_S2, 		nbins_S2height, 	min_S2height, 	max_S2height);
	TH2F *h2_S2HEIGHTBOTvsS2BOT 			= new TH2F("h2_S2HEIGHTBOTvsS2BOT",				DataSetName1, 	nbins_S2, 			min_S2, 		max_S2, 		nbins_S2height, 	min_S2height, 	max_S2height);

	h1_S1a->SetLineColor(1);
	h1_S1b->SetLineColor(2);
	...
	TCanvas *c_S1 = new TCanvas("c_S1", "c_S1", 0, 0, 700, 500);
    		 ...
    		 //c_S1->SetLogy();
		T1 ->Draw("S1totalPE>>h1_S1",	cut_PlotAll,	"");
		//h1_S1 	->Scale(ScalingFactor);
		//h1_S1 	->Scale(1e3);
		h1_S1	-> GetXaxis() -> SetTitle("S1 total [PE]");
		h1_S1	-> GetYaxis() -> SetTitle("Counts");
		h1_S1	-> GetXaxis() -> CenterTitle(true);
		h1_S1	-> GetYaxis() -> CenterTitle(true);
	c_S1->Update();
	...
	TCanvas *c_S1chi2vsS1bot = new TCanvas("c_S1chi2vsS1bot", "c_S1chi2vsS1bot", 0, 0, 700, 500);
		...
		h2_S1chi2vsS1bot	-> GetXaxis() -> SetTitle("largest S1[0] top [PE]");
	...
	TCanvas *c_S1twoPeaks = new TCanvas("c_S1twoPeaks", "c_S1twoPeaks", 0, 0, 700, 500);
		...
		T1 ->Draw("S1totalPE>>h1_S1a",	cut_PlotAll,	"");
		T1 ->Draw("S1totalPE1>>h1_S1b",	cut_PlotAll,	"same");
		//h1_S1a 	->Scale(ScalingFactor);
		//h1_S1a 	->Scale(1e3);
		//h1_S1b 	->Scale(ScalingFactor);
		//h1_S1b 	->Scale(1e3);
		h1_S1a	-> GetXaxis() -> SetTitle("S1 total [PE]");
		h1_S1a	-> GetYaxis() -> SetTitle("Counts");
		h1_S1a	-> GetXaxis() -> CenterTitle(true);
		h1_S1a	-> GetYaxis() -> CenterTitle(true);
	c_S1twoPeaks->Update();

	TCanvas *c_S2 = new TCanvas("c_S2", "c_S2", 0, 0, 700, 500);
			 c_S2->SetFillColor(10);
    		 c_S2->SetLogy();
		T1	->Draw("S2totalPE>>h1_S2",	cut_PlotAll,	"");
	...
	TCanvas *c_S2TOPvsS1 = new TCanvas("c_S2TOPvsS1", "c_S2TOPvsS1", 0, 0, 700, 500);
    		 ...
    		 c_S2TOPvsS1->SetLogz();
		T1	->Draw("S2topPE:S1totalPE>>h2_S2vsS1",	cut_PlotAll,	"COLZ");
	...
	TCanvas *c_S1ASYM1vsS1 = new TCanvas("c_S1ASYM1vsS1", "c_S1ASYM1vsS1", 0, 0, 700, 500);
		...
		h2_S1ASYM1vsS1	-> GetXaxis() -> SetTitle("total S1 [PE]");
	...
	TCanvas *c_S1ASYMvsDT = new TCanvas("c_S1ASYMvsDT", "c_S1ASYMvsDT", 0, 0, 700, 500);
		...
		T1	->Draw("S1asym:dt_top>>h2_S1ASYMvsDT",	cut_PlotAll,	"COLZ");
	...
	TCanvas *c_DT = new TCanvas("c_DT", "c_DT", 0, 0, 700, 500);
    		 ...
    		 c_DT->SetLogy();
		T1	->Draw("dt_top>>h1_DT",	cut_PlotAll,	"");
	...
	TCanvas *c_S1delay = new TCanvas("c_S1delay", "c_S1delay", 0, 0, 700, 500);
    		 ...
    		 c_S1delay->SetLogy();
		T1	->Draw("S1time1_bot-S1time_bot>>h1_S1delay",	cut_PlotAll,	"");
		//h1_S1delay	-> Scale(ScalingFactor);
		h1_S1delay	-> GetXaxis() -> SetTitle("delayed time between S1 pulses [#mus]");
		h1_S1delay	-> GetYaxis() -> SetTitle("Counts");
		h1_S1delay	-> GetXaxis() -> CenterTitle(true);
		h1_S1delay	-> GetYaxis() -> CenterTitle(true);
	c_S1delay->Update();

	TCanvas *c_S2vsDT = new TCanvas("c_S2vsDT", "c_S2vsDT", 0, 0, 700, 500);
			 c_S2vsDT->SetFillColor(10);
    		 c_S2vsDT->SetLogz();
		T1	->Draw("S2totalPE:dt_top>>h2_S2vsDT",	cut_PlotAll,	"COLZ");
	...
	TCanvas *c_S2TOPvsDT = new TCanvas("c_S2TOPvsDT", "c_S2TOPvsDT", 0, 0, 700, 500);
    		 ...
    		 c_S2TOPvsDT->SetLogz();
		T1	->Draw("S2topPE:dt_top>>h2_S2TOPvsDT",	cut_PlotAll,	"COLZ");
	...
	TCanvas *c_S1vsDT = new TCanvas("c_S1vsDT", "c_S1vsDT", 0, 0, 700, 500);
    		 ...
    		 c_S1vsDT->SetLogz();
		T1	->Draw("S1totalPE:dt_top>>h2_S1vsDT",	cut_PlotAll,	"COLZ");
	...
	TCanvas *c_S2WIDTHTOPvsDT = new TCanvas("c_S2WIDTHTOPvsDT", "c_S2WIDTHTOPvsDT", 0, 0, 700, 500);
		...
		T1	->Draw("S2width_top:dt_top>>h2_S2WIDTHTOPvsDT", cut_PlotAll, "COLZ");
	...
	TCanvas *c_S2WIDTHLOWTOPvsDT = new TCanvas("c_S2WIDTHLOWTOPvsDT", "c_S2WIDTHLOWTOPvsDT", 0, 0, 700, 500);
		...
		T1	->Draw("S2widthLow_top:dt_top>>h2_S2WIDTHLOWTOPvsDT", cut_PlotAll, "COLZ");
	...
	TCanvas *c_S2WIDTHoverHEIGHTTOPvsS2TOP = new TCanvas("c_S2WIDTHoverHEIGHTTOPvsS2TOP", "c_S2WIDTHoverHEIGHTTOPvsS2TOP", 0, 0, 700, 500);
		...
		T1	->Draw("S2width_top/S2height_top:S2topPE>>h2_S2WIDTHoverHEIGHTvsS2", cut_PlotAll, "COLZ");
	...
	// EXTRA PLOTS
/*	TCanvas *c_nS1 = new TCanvas("c_nS1", "c_nS1", 0, 0, 700, 500);
			 c_nS1->SetFillColor(10);
		T1	->Draw("S1peaks_top:S1peaks_bot>>h1_nS1",	cut_PlotAll,	"");
		h1_nS1	-> GetXaxis() -> SetTitle("Number of S1 candidates, bottom [PE]");
		h1_nS1	-> GetYaxis() -> SetTitle("Number of S1 candidates, top [PE]");
		h1_nS1	-> GetXaxis() -> CenterTitle(true);
		h1_nS1	-> GetYaxis() -> CenterTitle(true);
	c_nS1->Update();
*/

/*	TH1F *h1_S1raw1 = new TH1F("h1_S1raw1",	"", nbins_S1, min_S1, max_S1);
		  h1_S1raw1 ->SetLineColor(1);
	TH1F *h1_S1raw2 = new TH1F("h1_S1raw2",	"", nbins_S1, min_S1, max_S1);
		  h1_S1raw2 ->SetLineColor(2);
	TCanvas *c_S1raw = new TCanvas("c_S1raw", "c_S1raw", 0, 0, 700, 500);
			 c_S1raw->SetFillColor(10);
    		 c_S1raw->SetLogy();
		T1	->Draw("S1top*0.14>>h1_S1raw1",	cut_PlotAll,	"");
		T1	->Draw("S1bot*3.7e-2>>h1_S1raw2",	cut_PlotAll,	"same");
		h1_S1raw1	-> GetXaxis() -> SetTitle("S1 total [int. ADC samples]");
		h1_S1raw1	-> GetYaxis() -> SetTitle("events");
		h1_S1raw1	-> GetXaxis() -> CenterTitle(true);
		h1_S1raw1	-> GetYaxis() -> CenterTitle(true);
	c_S1raw->Update();
*/
...
/*	// CALCULATIONS, PLOT UPDATES
	c_S1->cd();
		TF1 *fit_S1 = new TF1("fit_S1", "gaus", 650, 1100);
		     fit_S1->SetLineColor(2);
		h1_S1	->Fit("fit_S1","R");
		fit_S1	->Draw("same");
		double S1_mean 		= fit_S1->GetParameter(1);
		double S1_meanEr 	= fit_S1->GetParError(1);
		double S1_sigma		= fit_S1->GetParameter(2);
		double S1_sigmaEr	= fit_S1->GetParError(2);
		double energy		= 122.0; // keV
		double LY			= S1_mean/energy;
		double LYer			= S1_meanEr/energy;
		double resolution 	= (S1_sigma/S1_mean)*100; // %
		cout <<"Light yield = "<< LY <<" +- "<< LYer <<" pe/keV"<< endl;

	TPaveStats *pts_S1 = new TPaveStats(0.5816993,0.5631068,0.8954248,0.8932039,"brNDC");
				pts_S1->SetName("stats");
				pts_S1->SetBorderSize(0);
				pts_S1->SetFillColor(10);
				pts_S1->SetTextAlign(12);
				pts_S1->SetTextFont(42);
				pts_S1->Draw();
				h1_S1->GetListOfFunctions()->Add(pts_S1);
		TPaveText *ptxt_S1 = new TPaveText(0.6091954,0.7733051,0.8893678,0.8728814,"NDC");
				   ptxt_S1->SetBorderSize(0);
				   ptxt_S1->SetFillColor(10);
			char txt_LY[100];
			sprintf(txt_LY,"Light Yield: %1.1f pe/keV", LY);
			char txt_resS1[100];
			sprintf(txt_resS1,"Resolution: %1.1f %%", resolution);
		ptxt_S1->AddText(txt_LY);
		ptxt_S1->AddText(txt_resS1);
		ptxt_S1->Draw();

	c_S1->Update();
*/

/*	TCanvas *c_Baseline = new TCanvas("c_Baseline", "c_Baseline", 0, 0, 700, 500);
			 c_Baseline->SetFillColor(10);
    		 c_Baseline->SetLogy();
		T1	->Draw("baseline_top",	cut_PlotAll,	"");
		//h1_S1	-> GetXaxis() -> SetTitle("S1 total [PE]");
		//h1_S1	-> GetYaxis() -> SetTitle("events");
		//h1_S1	-> GetXaxis() -> CenterTitle(true);
		//h1_S1	-> GetYaxis() -> CenterTitle(true);
	c_Baseline->Update();

	TCanvas *c_S1time = new TCanvas("c_S1time", "c_S1time", 0, 0, 700, 500);
			 c_S1time->SetFillColor(10);
    		 c_S1time->SetLogy();
		T1	->Draw("S1time_top",	cut_PlotAll,	"");
		//h1_S2	-> GetXaxis() -> SetTitle("S2 total [PE]");
		//h1_S2	-> GetYaxis() -> SetTitle("events");
		//h1_S2	-> GetXaxis() -> CenterTitle(true);
		//h1_S2	-> GetYaxis() -> CenterTitle(true);
	c_S1time->Update();

	TCanvas *c_S2time = new TCanvas("c_S2time", "c_S2time", 0, 0, 700, 500);
			 c_S2time->SetFillColor(10);
    		 c_S2time->SetLogy();
		T1	->Draw("S2time_top",	cut_PlotAll,	"");
		//h1_S2	-> GetXaxis() -> SetTitle("S2 total [PE]");
		//h1_S2	-> GetYaxis() -> SetTitle("events");
		//h1_S2	-> GetXaxis() -> CenterTitle(true);
		//h1_S2	-> GetYaxis() -> CenterTitle(true);
...
/*	// plot selection in the S1ASYMvsS1 plot
	c_S1ASYMvsS1->cd();
		TLine *l1 = new TLine(250, -0.60, 700, -0.60);
		TLine *l2 = new TLine(250, -0.05, 700, -0.05);
		TLine *l3 = new TLine(250, -0.60, 250, -0.05);
		TLine *l4 = new TLine(700, -0.60, 700, -0.05);
		//TLine *l1 = new TLine(375, -0.45, 550, -0.45);
		//TLine *l2 = new TLine(375, -0.25, 550, -0.25);
		//TLine *l3 = new TLine(375, -0.45, 375, -0.25);
		//TLine *l4 = new TLine(550, -0.45, 550, -0.25);
		l1->SetLineColor(1);
		l2->SetLineColor(1);
		l3->SetLineColor(1);
		l4->SetLineColor(1);
...
/*	c_S2->cd();
		TF1 *fit_S2 = new TF1("fit_S2","gaus", 60e3, 110e3);
		...
		TPaveStats *ptstats_S2 = new TPaveStats(0.5114379,0.6432039,0.8986928,0.8956311,"brNDC");
...
*/
/*	c_S2TOP->cd();
		TF1 *fit_S2top = new TF1("fit_S2top","gaus", 50e3, 100e3);
		...
		TPaveStats *ptstats_S2top = new TPaveStats(0.5114379,0.6432039,0.8986928,0.8956311,"brNDC");
			...
			char text_S2top_4[256];
  			...
  			//sprintf(text_S2top_3, "#mu = (%1.0f #pm %1.0f) PE", S2mean, S2meanError);
  			//sprintf(text_S2top_4, "#sigma = (%1.0f #pm %1.0f) PE", S2sigma, S2sigmaError);
			TText *
					text_S2top = ptstats_S2top->AddText(text_S2top_1);
					text_S2top = ptstats_S2top->AddText(text_S2top_2);
					//text3 = ptstats3->AddText(text_S2top_3);
					//text3 = ptstats3->AddText(text_S2top_4);
   			ptstats_S2top->Draw();
...
*/
/*	c_S2BOT->cd();
		TF1 *fit_S2bot = new TF1("fit_S2bot","gaus", 15e3, 30e3);
		...
		TPaveStats *ptstats_S2bot = new TPaveStats(0.5114379,0.6432039,0.8986928,0.8956311,"brNDC");
			...
			char text_S2bot_4[256];
  			...
  			//sprintf(text_S2bot_3, "#mu = (%1.0f #pm %1.0f) PE", S2mean, S2meanError);
  			//sprintf(text_S2bot_4, "#sigma = (%1.0f #pm %1.0f) PE", S2sigma, S2sigmaError);
			TText *
					text_S2bot = ptstats_S2bot->AddText(text_S2bot_1);
					text_S2bot = ptstats_S2bot->AddText(text_S2bot_2);
					//text3 = ptstats3->AddText(text_S2bot_3);
					//text3 = ptstats3->AddText(text_S2bot_4);
   			ptstats_S2bot->Draw();
...
*/
	c_S1->cd();
		TF1 *fit4 = new TF1("fit4","gaus", 320, 600); // Co-57
		//TF1 *fit4 = new TF1("fit4","gaus", 120, 260); // Kr-83m
			 fit4->SetLineColor(2);
			 fit4->SetLineWidth(2);
		h1_S1->Fit(fit4,"R");
		double S1mean 		= fit4->GetParameter(1);
		double S1sigma		= fit4->GetParameter(2);		
		double S1meanError 	= fit4->GetParError(1);
		double S1sigmaError	= fit4->GetParError(2);
		// Co-57
		double LY 			= S1mean/122.0;
		double LYerror 		= S1meanError/122.0;
		// Kr-83m
		//double LY 			= S1mean/32.0;
		//double LYerror 		= S1meanError/32.0;
		double Eres = S1sigma/S1mean*100;
		TPaveStats *ptstats4 = new TPaveStats(0.5114379,0.6432039,0.8986928,0.8956311,"brNDC");
					ptstats4->SetName("stats");
					ptstats4->SetBorderSize(0);
					ptstats4->SetTextAlign(12);
					ptstats4->SetFillStyle(0);
					ptstats4->SetFillColor(0);
			char text4a[256];
			char text4b[256];
			char text4c[256];
			char text4d[256];
  			sprintf(text4a, "LY = %1.1f pe/keV", LY);
  			sprintf(text4b, "Res = %1.1f", Eres);
  			//sprintf(text4a, " ");
  			//sprintf(text4b, " ");
			TText *
					text4 = ptstats4->AddText(text4a);
					text4 = ptstats4->AddText(text4b);
					//text4 = ptstats4->AddText(text4c);
					//text4 = ptstats4->AddText(text4d);
   			ptstats4->Draw();
		double S1max = fit4->GetMaximum();
		h1_S1->SetMaximum(S1max*1.5);
	c_S1->Update();
