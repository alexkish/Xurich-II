#ifndef __XENON10PTEFLONHIT_H__
#define __XENON10PTEFLONHIT_H__
...
class XuerichTeflonHit: public G4VHit
{
public:
	XuerichTeflonHit();
	~XuerichTeflonHit();
	XuerichTeflonHit(const XuerichTeflonHit &);
	const XuerichTeflonHit & operator=(const XuerichTeflonHit &);
	G4int operator==(const XuerichTeflonHit &) const;
...
typedef G4THitsCollection<XuerichTeflonHit> XuerichTeflonHitsCollection;

extern G4Allocator<XuerichTeflonHit> XuerichTeflonHitAllocator;

inline void*
XuerichTeflonHit::operator new(size_t)
{
	return((void *) XuerichTeflonHitAllocator.MallocSingle());
}

inline void
XuerichTeflonHit::operator delete(void *pXuerichTeflonHit)
{
	XuerichTeflonHitAllocator.FreeSingle((XuerichTeflonHit*) pXuerichTeflonHit);
}
