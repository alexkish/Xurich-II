#ifndef __XENON10PDEADXEHIT_H__
#define __XENON10PDEADXEHIT_H__
...
class XuerichDeadXeHit: public G4VHit
{
public:
	XuerichDeadXeHit();
	~XuerichDeadXeHit();
	XuerichDeadXeHit(const XuerichDeadXeHit &);
	const XuerichDeadXeHit & operator=(const XuerichDeadXeHit &);
	G4int operator==(const XuerichDeadXeHit &) const;
...
typedef G4THitsCollection<XuerichDeadXeHit> XuerichDeadXeHitsCollection;

extern G4Allocator<XuerichDeadXeHit> XuerichDeadXeHitAllocator;

inline void*
XuerichDeadXeHit::operator new(size_t)
{
	return((void *) XuerichDeadXeHitAllocator.MallocSingle());
}

inline void
XuerichDeadXeHit::operator delete(void *pXuerichDeadXeHit)
{
	XuerichDeadXeHitAllocator.FreeSingle((XuerichDeadXeHit*) pXuerichDeadXeHit);
}
