#ifndef __XENON10PGXEHIT_H__
#define __XENON10PGXEHIT_H__
...
class XuerichGXeHit: public G4VHit
{
public:
	XuerichGXeHit();
	~XuerichGXeHit();
	XuerichGXeHit(const XuerichGXeHit &);
	const XuerichGXeHit & operator=(const XuerichGXeHit &);
	G4int operator==(const XuerichGXeHit &) const;
...
typedef G4THitsCollection<XuerichGXeHit> XuerichGXeHitsCollection;

extern G4Allocator<XuerichGXeHit> XuerichGXeHitAllocator;

inline void*
XuerichGXeHit::operator new(size_t)
{
	return((void *) XuerichGXeHitAllocator.MallocSingle());
}

inline void
XuerichGXeHit::operator delete(void *pXuerichGXeHit)
{
	XuerichGXeHitAllocator.FreeSingle((XuerichGXeHit*) pXuerichGXeHit);
}
